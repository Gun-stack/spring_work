		...
		<form action="boardwrite" method="post" enctype="multipart/form-data" name="boardform">
			<table>
				<tr>
					...
					<td class="td_right"><input type="text" name="writer" id="writer" readonly="readonly" value="${user.id}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_right">
					<img id="image-box" width="100px" height="100px" src="resources/img/Noimage.jpg" />
